...
namespace PolygonIO.Model
{
        ...
        public partial class InlineResponse20035 :  IEquatable<InlineResponse20035>, IValidatableObject
    {
        ...
        public InlineResponse20035(DateTime? day = default(DateTime?), Object map = default(Object), int? msLatency = default(int?), string symbol = default(string), List<CryptoHistoricTradesTicks> ticks = default(List<CryptoHistoricTradesTicks>))
        {
            this.Day = day;
            this.Map = map;
