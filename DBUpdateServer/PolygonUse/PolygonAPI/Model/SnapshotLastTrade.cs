...
namespace PolygonIO.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SnapshotLastTrade :  IEquatable<SnapshotLastTrade>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SnapshotLastTrade" /> class.
        /// </summary>
        ...
        public SnapshotLastTrade(List<string> c = default(List<string>), int? i = default(int?), double? p = default(double?), int? s = default(int?), int? t = default(int?), int? x = default(int?))
        {
            this.C = c;
            this.I = i;
            this.P = p;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SnapshotLastTrade {\n");
        ...
        {
            return this.Equals(input as SnapshotLastTrade);
        }

        /// <summary>
        /// Returns true if SnapshotLastTrade instances are equal
        /// </summary>
        /// <param name="input">Instance of SnapshotLastTrade to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SnapshotLastTrade input)
        {
            if (input == null)
                return false;
