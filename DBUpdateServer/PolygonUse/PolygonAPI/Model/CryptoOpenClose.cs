...
namespace PolygonIO.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CryptoOpenClose :  IEquatable<CryptoOpenClose>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptoOpenClose" /> class.
        /// </summary>
        ...
        public CryptoOpenClose(string symbol = default(string), bool? isUTC = default(bool?), DateTime? day = default(DateTime?), double? open = default(double?), double? close = default(double?), List<CryptoHistoricTradesTicks> openTrades = default(List<CryptoHistoricTradesTicks>), List<CryptoHistoricTradesTicks> closingTrades = default(List<CryptoHistoricTradesTicks>))
        {
            this.Symbol = symbol;
            this.IsUTC = isUTC;
            this.Day = day;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptoOpenClose {\n");
        ...
        {
            return this.Equals(input as CryptoOpenClose);
        }

        /// <summary>
        /// Returns true if CryptoOpenClose instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptoOpenClose to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptoOpenClose input)
        {
            if (input == null)
                return false;
