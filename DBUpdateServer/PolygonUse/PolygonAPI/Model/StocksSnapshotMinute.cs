...
namespace PolygonIO.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StocksSnapshotMinute :  IEquatable<StocksSnapshotMinute>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StocksSnapshotMinute" /> class.
        /// </summary>
        ...
        public StocksSnapshotMinute(int? av = default(int?), double? o = default(double?), double? h = default(double?), double? l = default(double?), double? c = default(double?), double? v = default(double?), double? vw = default(double?))
        {
            this.Av = av;
            this.O = o;
            this.H = h;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StocksSnapshotMinute {\n");
        ...
        {
            return this.Equals(input as StocksSnapshotMinute);
        }

        /// <summary>
        /// Returns true if StocksSnapshotMinute instances are equal
        /// </summary>
        /// <param name="input">Instance of StocksSnapshotMinute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StocksSnapshotMinute input)
        {
            if (input == null)
                return false;
