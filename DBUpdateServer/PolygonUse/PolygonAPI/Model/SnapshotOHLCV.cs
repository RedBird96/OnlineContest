...
namespace PolygonIO.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SnapshotOHLCV :  IEquatable<SnapshotOHLCV>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SnapshotOHLCV" /> class.
        /// </summary>
        ...
        public SnapshotOHLCV(double? o = default(double?), double? h = default(double?), double? l = default(double?), double? c = default(double?), double? v = default(double?))
        {
            this.O = o;
            this.H = h;
            this.L = l;
        ...
        {
            return this.Equals(input as SnapshotOHLCV);
        }

        /// <summary>
        /// Returns true if SnapshotOHLCV instances are equal
        /// </summary>
        /// <param name="input">Instance of SnapshotOHLCV to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SnapshotOHLCV input)
        {
            if (input == null)
                return false;
