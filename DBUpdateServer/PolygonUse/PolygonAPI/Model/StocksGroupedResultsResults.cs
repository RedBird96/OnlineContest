...
{
    /// <summary>
    /// StocksGroupedResultsResults
    /// </summary>
    [DataContract]
        public partial class StocksGroupedResultsResults :  IEquatable<StocksGroupedResultsResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StocksGroupedResultsResults" /> class.
        /// </summary>
        ...
        public StocksGroupedResultsResults(string symbol = default(string), double? o = default(double?), double? h = default(double?), double? l = default(double?), double? c = default(double?), double? v = default(double?), double? vw = default(double?), int? t = default(int?), decimal? n = default(decimal?))
        {
            this.Symbol = symbol;
            this.O = o;
            this.H = h;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StocksGroupedResultsResults {\n");
        ...
        {
            return this.Equals(input as StocksGroupedResultsResults);
        }

        /// <summary>
        /// Returns true if StocksGroupedResultsResults instances are equal
        /// </summary>
        /// <param name="input">Instance of StocksGroupedResultsResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StocksGroupedResultsResults input)
        {
            if (input == null)
                return false;
