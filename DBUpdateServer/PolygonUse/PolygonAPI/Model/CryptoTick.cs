...
namespace PolygonIO.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CryptoTick :  IEquatable<CryptoTick>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptoTick" /> class.
        /// </summary>
        ...
        public CryptoTick(double? p = default(double?), double? s = default(double?), int? x = default(int?), List<int?> c = default(List<int?>), int? t = default(int?))
        {
            this.P = p;
            this.S = s;
            this.X = x;
        ...
        {
            return this.Equals(input as CryptoTick);
        }

        /// <summary>
        /// Returns true if CryptoTick instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptoTick to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptoTick input)
        {
            if (input == null)
                return false;
