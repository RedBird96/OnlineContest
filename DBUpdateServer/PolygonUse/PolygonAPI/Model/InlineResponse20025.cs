...
namespace PolygonIO.Model
{
        ...
        public partial class InlineResponse20025 :  IEquatable<InlineResponse20025>, IValidatableObject
    {
        ...
        public InlineResponse20025(ForexConversionLast last = default(ForexConversionLast), string from = default(string), string to = default(string), double? initialAmount = default(double?), double? converted = default(double?))
        {
            this.Last = last;
            this.From = from;
            this.To = to;
