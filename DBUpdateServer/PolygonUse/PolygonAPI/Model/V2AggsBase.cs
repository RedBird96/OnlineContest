...
namespace PolygonIO.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class V2AggsBase :  IEquatable<V2AggsBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2AggsBase" /> class.
        /// </summary>
        ...
        public V2AggsBase(string status = default(string), bool? adjusted = default(bool?), int? queryCount = default(int?), int? resultsCount = default(int?), string requestId = default(string))
        {
            this.Status = status;
        ...
        {
            return this.Equals(input as V2AggsBase);
        }

        /// <summary>
        /// Returns true if V2AggsBase instances are equal
        /// </summary>
        /// <param name="input">Instance of V2AggsBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2AggsBase input)
        {
            if (input == null)
                return false;
