...
namespace PolygonIO.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CryptoSnapshotMinute :  IEquatable<CryptoSnapshotMinute>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptoSnapshotMinute" /> class.
        /// </summary>
        ...
        public CryptoSnapshotMinute(double? o = default(double?), double? h = default(double?), double? l = default(double?), double? c = default(double?), double? v = default(double?), double? vw = default(double?))
        {
            this.O = o;
            this.H = h;
            this.L = l;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptoSnapshotMinute {\n");
        ...
        {
            return this.Equals(input as CryptoSnapshotMinute);
        }

        /// <summary>
        /// Returns true if CryptoSnapshotMinute instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptoSnapshotMinute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptoSnapshotMinute input)
        {
            if (input == null)
                return false;
