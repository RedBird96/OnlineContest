...
{
    /// <summary>
    /// ForexGroupedResultsResults
    /// </summary>
    [DataContract]
        public partial class ForexGroupedResultsResults :  IEquatable<ForexGroupedResultsResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForexGroupedResultsResults" /> class.
        /// </summary>
        ...
        public ForexGroupedResultsResults(string symbol = default(string), double? o = default(double?), double? h = default(double?), double? l = default(double?), double? c = default(double?), double? v = default(double?), int? t = default(int?))
        {
            this.Symbol = symbol;
            this.O = o;
            this.H = h;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForexGroupedResultsResults {\n");
        ...
        {
            return this.Equals(input as ForexGroupedResultsResults);
        }

        /// <summary>
        /// Returns true if ForexGroupedResultsResults instances are equal
        /// </summary>
        /// <param name="input">Instance of ForexGroupedResultsResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForexGroupedResultsResults input)
        {
            if (input == null)
                return false;
