...
namespace PolygonIO.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ForexSnapshotTickerTickerMin :  IEquatable<ForexSnapshotTickerTickerMin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForexSnapshotTickerTickerMin" /> class.
        /// </summary>
        ...
        public ForexSnapshotTickerTickerMin(double? o = default(double?), double? h = default(double?), double? l = default(double?), double? c = default(double?), double? v = default(double?))
        {
            this.O = o;
            this.H = h;
            this.L = l;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForexSnapshotTickerTickerMin {\n");
        ...
        {
            return this.Equals(input as ForexSnapshotTickerTickerMin);
        }

        /// <summary>
        /// Returns true if ForexSnapshotTickerTickerMin instances are equal
        /// </summary>
        /// <param name="input">Instance of ForexSnapshotTickerTickerMin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForexSnapshotTickerTickerMin input)
        {
            if (input == null)
                return false;
