...
{
    /// <summary>
    /// CryptoGroupedResultsResults
    /// </summary>
    [DataContract]
        public partial class CryptoGroupedResultsResults :  IEquatable<CryptoGroupedResultsResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptoGroupedResultsResults" /> class.
        /// </summary>
        ...
        public CryptoGroupedResultsResults(string symbol = default(string), double? o = default(double?), double? h = default(double?), double? l = default(double?), double? c = default(double?), double? v = default(double?), double? vw = default(double?), int? t = default(int?))
        {
            this.Symbol = symbol;
            this.O = o;
            this.H = h;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptoGroupedResultsResults {\n");
        ...
        {
            return this.Equals(input as CryptoGroupedResultsResults);
        }

        /// <summary>
        /// Returns true if CryptoGroupedResultsResults instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptoGroupedResultsResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptoGroupedResultsResults input)
        {
            if (input == null)
                return false;
