...
namespace PolygonIO.Model
{
        ...
        public partial class InlineResponse20019 :  IEquatable<InlineResponse20019>, IValidatableObject
    {
        ...
        public InlineResponse20019(string status = default(string), bool? adjusted = default(bool?), int? queryCount = default(int?), int? resultsCount = default(int?), string requestId = default(string), List<TickerResultsResults> results = default(List<TickerResultsResults>))
        {
            this.Status = status;
