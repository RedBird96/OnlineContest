...
namespace PolygonIO.Model
{
        ...
        public partial class InlineResponse20011 :  IEquatable<InlineResponse20011>, IValidatableObject
    {
        ...
        public InlineResponse20011(string market = default(string), DateTime? serverTime = default(DateTime?), MarketStatusExchanges exchanges = default(MarketStatusExchanges), MarketStatusCurrencies currencies = default(MarketStatusCurrencies))
        {
            this.Market = market;
