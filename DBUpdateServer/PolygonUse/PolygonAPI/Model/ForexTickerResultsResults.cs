...
{
    /// <summary>
    /// ForexTickerResultsResults
    /// </summary>
    [DataContract]
        public partial class ForexTickerResultsResults :  IEquatable<ForexTickerResultsResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForexTickerResultsResults" /> class.
        /// </summary>
        ...
        public ForexTickerResultsResults(double? o = default(double?), double? h = default(double?), double? l = default(double?), double? c = default(double?), double? v = default(double?), int? t = default(int?), decimal? n = default(decimal?))
        {
            this.O = o;
            this.H = h;
            this.L = l;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForexTickerResultsResults {\n");
        ...
        {
            return this.Equals(input as ForexTickerResultsResults);
        }

        /// <summary>
        /// Returns true if ForexTickerResultsResults instances are equal
        /// </summary>
        /// <param name="input">Instance of ForexTickerResultsResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForexTickerResultsResults input)
        {
            if (input == null)
                return false;
