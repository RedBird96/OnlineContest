...
namespace PolygonIO.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SnapshotOHLCVVW :  IEquatable<SnapshotOHLCVVW>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SnapshotOHLCVVW" /> class.
        /// </summary>
        ...
        public SnapshotOHLCVVW(double? o = default(double?), double? h = default(double?), double? l = default(double?), double? c = default(double?), double? v = default(double?), double? vw = default(double?))
        {
            this.O = o;
            this.H = h;
            this.L = l;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SnapshotOHLCVVW {\n");
        ...
        {
            return this.Equals(input as SnapshotOHLCVVW);
        }

        /// <summary>
        /// Returns true if SnapshotOHLCVVW instances are equal
        /// </summary>
        /// <param name="input">Instance of SnapshotOHLCVVW to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SnapshotOHLCVVW input)
        {
            if (input == null)
                return false;
