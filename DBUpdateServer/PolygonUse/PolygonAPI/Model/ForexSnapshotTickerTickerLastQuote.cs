...
{
    /// <summary>
    /// ForexSnapshotTickerTickerLastQuote
    /// </summary>
    [DataContract]
        public partial class ForexSnapshotTickerTickerLastQuote :  IEquatable<ForexSnapshotTickerTickerLastQuote>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForexSnapshotTickerTickerLastQuote" /> class.
        /// </summary>
        ...
        public ForexSnapshotTickerTickerLastQuote(double? a = default(double?), double? b = default(double?), int? t = default(int?), int? x = default(int?))
        {
            this.A = a;
            this.B = b;
            this.T = t;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForexSnapshotTickerTickerLastQuote {\n");
        ...
        {
            return this.Equals(input as ForexSnapshotTickerTickerLastQuote);
        }

        /// <summary>
        /// Returns true if ForexSnapshotTickerTickerLastQuote instances are equal
        /// </summary>
        /// <param name="input">Instance of ForexSnapshotTickerTickerLastQuote to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForexSnapshotTickerTickerLastQuote input)
        {
            if (input == null)
                return false;
