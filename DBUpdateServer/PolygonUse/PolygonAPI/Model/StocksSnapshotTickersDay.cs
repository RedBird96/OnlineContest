...
{
    /// <summary>
    /// StocksSnapshotTickersDay
    /// </summary>
    [DataContract]
        public partial class StocksSnapshotTickersDay :  IEquatable<StocksSnapshotTickersDay>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StocksSnapshotTickersDay" /> class.
        /// </summary>
        ...
        public StocksSnapshotTickersDay(double? o = default(double?), double? h = default(double?), double? l = default(double?), double? c = default(double?), double? v = default(double?), double? vw = default(double?))
        {
            this.O = o;
            this.H = h;
            this.L = l;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StocksSnapshotTickersDay {\n");
        ...
        {
            return this.Equals(input as StocksSnapshotTickersDay);
        }

        /// <summary>
        /// Returns true if StocksSnapshotTickersDay instances are equal
        /// </summary>
        /// <param name="input">Instance of StocksSnapshotTickersDay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StocksSnapshotTickersDay input)
        {
            if (input == null)
                return false;
