...
namespace PolygonIO.Model
{
        ...
        public partial class Financials :  IEquatable<Financials>, IValidatableObject
    {
        ...
        public Financials(string ticker = default(string), PeriodEnum? period = default(PeriodEnum?), DateTime? calendarDate = default(DateTime?), DateTime? reportPeriod = default(DateTime?), DateTime? updated = default(DateTime?), int? accumulatedOtherComprehensiveIncome = default(int?), int? assets = default(int?), int? assetsAverage = default(int?), int? assetsCurrent = default(int?), int? assetTurnover = default(int?), int? assetsNonCurrent = default(int?), double? bookValuePerShare = default(double?), int? capitalExpenditure = default(int?), int? cashAndEquivalents = default(int?), int? cashAndEquivalentsUSD = default(int?), int? costOfRevenue = default(int?), int? consolidatedIncome = default(int?), double? currentRatio = default(double?), double? debtToEquityRatio = default(double?), int? debt = default(int?), int? debtCurrent = default(int?), int? debtNonCurrent = default(int?), int? debtUSD = default(int?), int? deferredRevenue = default(int?), int? depreciationAmortizationAndAccretion = default(int?), int? deposits = default(int?), int? dividendYield = default(int?), int? dividendsPerBasicCommonShare = default(int?), int? earningBeforeInterestTaxes = default(int?), int? earningsBeforeInterestTaxesDepreciationAmortization = default(int?), double? eBITDAMargin = default(double?), int? earningsBeforeInterestTaxesDepreciationAmortizationUSD = default(int?), int? earningBeforeInterestTaxesUSD = default(int?), int? earningsBeforeTax = default(int?), double? earningsPerBasicShare = default(double?), double? earningsPerDilutedShare = default(double?), double? earningsPerBasicShareUSD = default(double?), int? shareholdersEquity = default(int?), int? averageEquity = default(int?), int? shareholdersEquityUSD = default(int?), int? enterpriseValue = default(int?), int? enterpriseValueOverEBIT = default(int?), double? enterpriseValueOverEBITDA = default(double?), int? freeCashFlow = default(int?), double? freeCashFlowPerShare = default(double?), int? foreignCurrencyUSDExchangeRate = default(int?), int? grossProfit = default(int?), double? grossMargin = default(double?), int? goodwillAndIntangibleAssets = default(int?), int? interestExpense = default(int?), int? investedCapital = default(int?), int? investedCapitalAverage = default(int?), int? inventory = default(int?), int? investments = default(int?), int? investmentsCurrent = default(int?), int? investmentsNonCurrent = default(int?), int? totalLiabilities = default(int?), int? currentLiabilities = default(int?), int? liabilitiesNonCurrent = default(int?), int? marketCapitalization = default(int?), int? netCashFlow = default(int?), int? netCashFlowBusinessAcquisitionsDisposals = default(int?), int? issuanceEquityShares = default(int?), int? issuanceDebtSecurities = default(int?), int? paymentDividendsOtherCashDistributions = default(int?), int? netCashFlowFromFinancing = default(int?), int? netCashFlowFromInvesting = default(int?), int? netCashFlowInvestmentAcquisitionsDisposals = default(int?), int? netCashFlowFromOperations = default(int?), int? effectOfExchangeRateChangesOnCash = default(int?), int? netIncome = default(int?), int? netIncomeCommonStock = default(int?), int? netIncomeCommonStockUSD = default(int?), int? netLossIncomeFromDiscontinuedOperations = default(int?), int? netIncomeToNonControllingInterests = default(int?), double? profitMargin = default(double?), int? operatingExpenses = default(int?), int? operatingIncome = default(int?), int? tradeAndNonTradePayables = default(int?), int? payoutRatio = default(int?), double? priceToBookValue = default(double?), double? priceEarnings = default(double?), double? priceToEarningsRatio = default(double?), int? propertyPlantEquipmentNet = default(int?), int? preferredDividendsIncomeStatementImpact = default(int?), double? sharePriceAdjustedClose = default(double?), double? priceSales = default(double?), double? priceToSalesRatio = default(double?), int? tradeAndNonTradeReceivables = default(int?), int? accumulatedRetainedEarningsDeficit = default(int?), int? revenues = default(int?), int? revenuesUSD = default(int?), int? researchAndDevelopmentExpense = default(int?), int? returnOnAverageAssets = default(int?), int? returnOnAverageEquity = default(int?), int? returnOnInvestedCapital = default(int?), double? returnOnSales = default(double?), int? shareBasedCompensation = default(int?), int? sellingGeneralAndAdministrativeExpense = default(int?), int? shareFactor = default(int?), int? shares = default(int?), int? weightedAverageShares = default(int?), int? weightedAverageSharesDiluted = default(int?), double? salesPerShare = default(double?), int? tangibleAssetValue = default(int?), int? taxAssets = default(int?), int? incomeTaxExpense = default(int?), int? taxLiabilities = default(int?), double? tangibleAssetsBookValuePerShare = default(double?), int? workingCapital = default(int?))
        {
            // to ensure "ticker" is required (not null)
            if (ticker == null)
            {
                throw new InvalidDataException("ticker is a required property for Financials and cannot be null");
            }
            else
            {
                this.Ticker = ticker;
