...
{
    /// <summary>
    /// ForexSnapshotTickerTickerDay
    /// </summary>
    [DataContract]
        public partial class ForexSnapshotTickerTickerDay :  IEquatable<ForexSnapshotTickerTickerDay>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForexSnapshotTickerTickerDay" /> class.
        /// </summary>
        ...
        public ForexSnapshotTickerTickerDay(double? o = default(double?), double? h = default(double?), double? l = default(double?), double? c = default(double?), double? v = default(double?))
        {
            this.O = o;
            this.H = h;
            this.L = l;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForexSnapshotTickerTickerDay {\n");
        ...
        {
            return this.Equals(input as ForexSnapshotTickerTickerDay);
        }

        /// <summary>
        /// Returns true if ForexSnapshotTickerTickerDay instances are equal
        /// </summary>
        /// <param name="input">Instance of ForexSnapshotTickerTickerDay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForexSnapshotTickerTickerDay input)
        {
            if (input == null)
                return false;
