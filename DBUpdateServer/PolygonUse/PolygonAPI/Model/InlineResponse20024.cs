...
namespace PolygonIO.Model
{
        ...
        public partial class InlineResponse20024 :  IEquatable<InlineResponse20024>, IValidatableObject
    {
        ...
        public InlineResponse20024(DateTime? day = default(DateTime?), Object map = default(Object), int? msLatency = default(int?), string pair = default(string), List<ForexHistoricTradesTicks> ticks = default(List<ForexHistoricTradesTicks>))
        {
            this.Day = day;
            this.Map = map;
