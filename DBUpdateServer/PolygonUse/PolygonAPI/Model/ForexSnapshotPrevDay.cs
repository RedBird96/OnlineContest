...
namespace PolygonIO.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ForexSnapshotPrevDay :  IEquatable<ForexSnapshotPrevDay>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForexSnapshotPrevDay" /> class.
        /// </summary>
        ...
        public ForexSnapshotPrevDay(double? o = default(double?), double? h = default(double?), double? l = default(double?), double? c = default(double?), double? v = default(double?), double? vw = default(double?))
        {
            this.O = o;
            this.H = h;
            this.L = l;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForexSnapshotPrevDay {\n");
        ...
        {
            return this.Equals(input as ForexSnapshotPrevDay);
        }

        /// <summary>
        /// Returns true if ForexSnapshotPrevDay instances are equal
        /// </summary>
        /// <param name="input">Instance of ForexSnapshotPrevDay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForexSnapshotPrevDay input)
        {
            if (input == null)
                return false;
