...
{
    /// <summary>
    /// CryptoSnapshotTickerTicker
    /// </summary>
    [DataContract]
        public partial class CryptoSnapshotTickerTicker :  IEquatable<CryptoSnapshotTickerTicker>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptoSnapshotTickerTicker" /> class.
        /// </summary>
        ...
        public CryptoSnapshotTickerTicker(StocksSnapshotTickersDay day = default(StocksSnapshotTickersDay), AllOfCryptoSnapshotTickerTickerLastTrade lastTrade = default(AllOfCryptoSnapshotTickerTickerLastTrade), CryptoSnapshotTickerTickerMin min = default(CryptoSnapshotTickerTickerMin), StocksSnapshotTickersDay prevDay = default(StocksSnapshotTickersDay), string ticker = default(string), double? todaysChange = default(double?), double? todaysChangePerc = default(double?), int? updated = default(int?))
        {
            this.Day = day;
        ...
        public AllOfCryptoSnapshotTickerTickerLastTrade LastTrade { get; set; }

        /// <summary>
        /// Gets or Sets Min
        /// </summary>
        [DataMember(Name="min", EmitDefaultValue=false)]
        public CryptoSnapshotTickerTickerMin Min { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptoSnapshotTickerTicker {\n");
        ...
        {
            return this.Equals(input as CryptoSnapshotTickerTicker);
        }

        /// <summary>
        /// Returns true if CryptoSnapshotTickerTicker instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptoSnapshotTickerTicker to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptoSnapshotTickerTicker input)
        {
            if (input == null)
                return false;
