...
namespace PolygonIO.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CryptoHistoricTrades :  IEquatable<CryptoHistoricTrades>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptoHistoricTrades" /> class.
        /// </summary>
        ...
        public CryptoHistoricTrades(DateTime? day = default(DateTime?), Object map = default(Object), int? msLatency = default(int?), string symbol = default(string), List<CryptoHistoricTradesTicks> ticks = default(List<CryptoHistoricTradesTicks>))
        {
            this.Day = day;
            this.Map = map;
        ...
        public List<CryptoHistoricTradesTicks> Ticks { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CryptoHistoricTrades {\n");
        ...
        {
            return this.Equals(input as CryptoHistoricTrades);
        }

        /// <summary>
        /// Returns true if CryptoHistoricTrades instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptoHistoricTrades to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptoHistoricTrades input)
        {
            if (input == null)
                return false;
