...
namespace PolygonIO.Model
{
        ...
        public partial class InlineResponse20037 :  IEquatable<InlineResponse20037>, IValidatableObject
    {
        ...
        public InlineResponse20037(string status = default(string), bool? adjusted = default(bool?), int? queryCount = default(int?), int? resultsCount = default(int?), string requestId = default(string), List<CryptoGroupedResultsResults> results = default(List<CryptoGroupedResultsResults>))
        {
            this.Status = status;
